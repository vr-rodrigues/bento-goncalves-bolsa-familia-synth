...
\caption{Controle sintético -- pool Sul. Painéis à esquerda reportam famílias beneficiárias; painéis à direita reportam estoque de vínculos formais. Séries em média móvel de 3 meses. Efeito no último mês: Bolsa Família: -292 ($p_{FP}=0.077$); Estoque formal: 496 ($p_{FP}=0.048$).}
\label{fig:main-att}
...
A Figura~\ref{fig:main-att} reporta a trajetória observada e sintética, o gap com IC de 90\% e os placebos para os dois desfechos centrais. Dois resultados se destacam. O primeiro é a queda do Bolsa Família (-292; $p_{FP}=0.077$), que permanece negativa e economicamente relevante. O segundo é o aumento do estoque formal de 496 vínculos ($p_{FP}=0.048$), compatível com a hipótese de que parte da saída do programa pode ter coincidido com maior inserção no mercado formal local.
