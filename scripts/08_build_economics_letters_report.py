...
A literatura de transferências condicionadas dá conteúdo a essa segunda margem. Revisões mostram efeitos de longo prazo sobre capital humano e mercado de trabalho, com heterogeneidade por desenho e território \citep{{molinamillan2019longterm}}. No Brasil, avaliações do Bolsa Família encontram ganhos de escolaridade \citep{{glewwe2012bolsa,debrauw2015schooling}} e mobilidade posterior via saída de programas sociais e acesso ao emprego formal \citep{{fassarella2024mobility}}. Para o México, \citet{{parker2023cct}} mostram efeitos semelhantes entre gerações. A evidência sobre oferta de trabalho também é mais cautelosa do que a narrativa de desincentivo sugere \citep{{debrauw2015labor,barbosa2014informality,banerjee2017lazy}}. Estudos recentes encontram maior duração no emprego formal e efeitos positivos de expansão de transferências sobre emprego \citep{{santos2017duration,best2026productive}}.
