...
Os resultados sustentam monitoramento e investigação. Adoção em outros municípios deveria depender de replicação local, persistência dos efeitos e validação individual do mecanismo. A validade externa também deve variar com a capacidade local de transformar revisão cadastral em intermediação de trabalho. A evidência de \citet{{fassarella2024mobility}} sugere que a mobilidade de beneficiários do Bolsa Família depende de infraestrutura de saúde, educação e atividade econômica local, o que torna esse tipo de política mais promissor onde serviços e oportunidades já estão presentes. A próxima etapa é ligar Cadastro Único, folha de pagamentos do programa, RAIS/CAGED e trajetórias de renda. Esses dados permitiriam verificar se as famílias que saíram do programa foram absorvidas pelo mercado formal, em quais ocupações, com que salários e por quanto tempo. Se o mecanismo for confirmado, a experiência oferece uma hipótese concreta de política municipal a ser adaptada em outros contextos. Até lá, políticas que afetam renda, trabalho e acesso a direitos devem ser avaliadas com contrafactuais claros e comunicadas com incerteza.
